        ...
        <>
            {loading ?
                ...
                <div className="w-full lg:w-12/12 px-4">
                    ...
                    {url &&
                        <>
                            <button onClick={copyToClipboard} className="bg-red-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150 mb-10">
                                {copySuccess}
                            </button>
                            <form>
                                <textarea
